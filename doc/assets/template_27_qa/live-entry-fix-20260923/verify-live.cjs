...
(async () => {
  ...
  try {
    ...
    const assetResponse = await page.request.get(
      'http://127.0.0.1:5778/api/data/template_27.jpg',
    );
    ...
    const summary = {
      ...
      authenticationMode: 'browser-only-test-identity',
      backendMode: 'normal-local-main-api',

...
from utils.finalize_template_28_qa import persist_manifest


def records():
    pending = {'candidate': 'template_28-fixed', 'productionFiles': {'template.json': 'original'},
...
def test_changed_delivery_does_not_reuse_old_confirmation(tmp_path, field):
    ...
    pending[field] = 'template_28-new' if field == 'candidate' else {'changed': 'new-hash'}

...
@media (max-width: 1024px) and (min-width: 769px) { .save-status:not(.mobile) { right: 176px; max-width: min(360px, calc(100vw - 352px)); } }
@media (max-width: 768px) and (min-width: 601px) {
  .save-status:not(.mobile) { right: 142px; max-width: calc(100vw - 286px); }
  .save-status:not(.mobile) .status-copy span:last-child { max-width: 118px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
}

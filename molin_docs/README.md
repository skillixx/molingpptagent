...
| [TrainPPTAgent积分非生产联调验收报告-BG04.md](./TrainPPTAgent积分非生产联调验收报告-BG04.md) | TrainPPTAgent BG04 报告 | 测试服只读矩阵、受控写入门禁与双边证据状态 |
| [TrainPPTAgent-BG04隔离UAT实例运行手册.md](./TrainPPTAgent-BG04隔离UAT实例运行手册.md) | TrainPPTAgent BG04 运维手册 | 独立数据库、0008 迁移、开关门禁与恢复顺序 |
